...
public class SpringApplicationContext implements ApplicationContextAware {
	...
	public static String getBeanId(Class beanClass) {
		String beanId = null;
		String[] beans = CONTEXT.getBeanNamesForType(beanClass);

		if(beans != null && beans.length == 1) {
			beanId = beans[0];
		} else {
			System.out.println("Unable to find the class in Spring Application Context " + beanClass.getName());
		}
